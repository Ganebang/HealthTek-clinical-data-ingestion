...
def create_dim_establishment(silver_finess_path: Path, output_path: Path) -> Dict[str, Any]:
    """
    ...
    logger.info(
        f"Deduplicated: {deduped_rows:,} unique establishments ({duplicates_removed:,} duplicates removed)"
    )
